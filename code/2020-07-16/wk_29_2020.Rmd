...
plot <- ggplot() +
  ...
  geom_text(
    ...
    color = "white", family = "NasalizationRg-Regular"
  ) +
  geom_text(
    aes(x = 0.2, y = c(6.2,-.2), label = c("CIVILIANS","MILITARY")), 
    color = "white", size = 4, family = "NasalizationRg-Regular"
  ) +
  geom_text(
    data = notes, aes(x, y,label = label), 
    color = "white", size = 3, family = "NasalizationRg-Regular"
  ) +
  annotation_custom(
  ...
  theme(
    ...
    plot.caption = element_text(color = "white", hjust = 0.5, vjust = 10, family = "NasalizationRg-Regular")
  )
```

```{r}
ggsave(here::here("plots/2020_30","wk_29_2020.png"), plot, width = 19.2, height = 10.8)
